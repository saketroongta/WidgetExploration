    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cbTransparency.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(cbTransparency.isChecked()) imageView.setAlpha(0.1f);
        ...
        cbTint.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(cbTint.isChecked()) imageView.setColorFilter(Color.argb(150, 255, 0, 0));
        ...
        switch1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked) webView.setVisibility(View.VISIBLE);
                else webView.setVisibility(View.INVISIBLE);
            }
        });
    }
}
